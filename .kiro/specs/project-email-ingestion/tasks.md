...
- [x] F1. 基盤層（V44・entity・mapper・DTO・IF・i18n・H2）
...
- [x] A. 抽出＋AI解析【担当: ProjectParseService impl / DTO】
...
- [x] B. 取込サービス【担当: ProjectIngestionServiceImpl】
...
- [x] C. API・画面【担当: *Controller / templates/project-ingestion / project-ingestion.js / sidebar】
