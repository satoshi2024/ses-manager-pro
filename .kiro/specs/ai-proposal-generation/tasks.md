...
- [ ] A. 実マッチング接続【担当: GeminiMatchingServiceImpl / 条件式】
...
- [ ] B. 提案生成サービス＋API【担当: ProposalDraftService / AiProposalController】
...
- [ ] C. フロント【担当: proposal-kanban.js / 提案モーダル / i18n】
