...
| B2 | delivery | 完了 | `ManagementReportScheduler`、schedule CAS/cron、保存scope、delivery token/scope/reauth/retry API、delivery preview経路、outbox idと`ENQUEUED`状態、dispatcher結果同期、retry due claim、汎用Document経路遮断、ENQUEUED再配布抑止 | `0e0d4d50` / `87d055a4` / `573cf60b` / `75490e79` / `95818da1` / `b925a1fc` / `b4b8c3b1`、delivery 7/7、dispatcher 5/5、scheduler 3/3、schedule 3/3、FileScope 6/6 |
