...
- [ ] A. バックエンドAPI・サービスロジック 【並行可・担当ファイル: service/impl/BpPaymentServiceImpl, controller/api/BpPaymentApiController, dto/bp/BpPaymentTreeDto, BpPaymentServiceImplTest】
...
- [ ] B. 画面(商流ツリー表示) 【並行可・担当ファイル: bp-payment/list.html, static/js/modules/bp-payment.js】
