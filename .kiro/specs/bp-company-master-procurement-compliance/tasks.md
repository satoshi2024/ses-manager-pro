...
> 後続のS08 CRMは **V73**（＋権限seedの**V74**）でmerge済み、S07 approvalは**V75**です。
...
- [x] F1. BP master/terms/contact/bank DDL
