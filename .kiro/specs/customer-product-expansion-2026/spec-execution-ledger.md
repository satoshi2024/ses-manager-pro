...
| 17 | 4 | `ai-feedback-learning` | T109〜T115 | **`FAIL`（Round 2）→ P1 fix 済 / 再Review待ち** | Round 2 P1=4。R2-P1-01〜04 を修正。R1-P2 は VERIFIED_CLOSED。本番は `GATE-S17-G10-PROD` | S17 Round 2 P1 fix | Base `9d2c229b` → Head `e90e0537` + P1 fix | 定向 44/0/0/0 | Round 3 Review。次specは開始しない。本番 PASS は G10 未閉じ |
