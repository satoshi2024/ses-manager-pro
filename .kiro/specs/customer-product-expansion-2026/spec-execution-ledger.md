...
R19-P1-02はVERIFIED_CLOSED。R21 second follow-up独立ReviewでP1-03/P1-04/P2-01はVERIFIED_CLOSED、P1-01〜02はOPENのまま、R19-P1-01はOPEN / DECISION_DELTA_REWORK_REQUIREDを維持する。今回のsecond follow-up docs-only fixは、時刻非依存delivery_business_key、legacy NULL download、future_slot lifecycle/rollbackを追加する。R10のACCEPTED_FOR_IMPLEMENTATION前はV102/DDL/code/testを作成しない。T066 checkbox・ACTIVE化・本番交付・S12開始は禁止維持。
