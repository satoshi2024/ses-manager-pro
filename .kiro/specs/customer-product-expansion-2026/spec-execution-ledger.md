...
| 17 | 4 | `ai-feedback-learning` | T109〜T115 | **`IN PROGRESS`（T109/T110完了、T111未着手）** | Round 1: T109 PASS / spec NOT REVIEWABLE。P2×3 は `214c6852` で文書/L0修正。T110=V108 DDL + ACTIVE CAS + outcome 冪等 | S17 ai-feedback-learning 実装 | Base `9d2c229b` → T109 `835c8c86` → P2 `214c6852` | H2 schema 6/0/0/0。MySQL smoke はローカル Docker 欠如で skip（CI shard-1） | T111 F2 gateway。次specは開始しない |
