...
| 11 | 2 | `attendance-leave-overtime-compliance` | T067〜T074 | `IN PROGRESS`（T067/T068/T069完了、T070〜T074未着手） | order PASS、G6確定済み。dispatchと並行可。V83は実装済みだがV82 merge/apply後に適用 | S11 attendance-leave-overtime-compliance 実装 | Base `5e29f39` → T067成果 `93c1ac6` → T068実装 `b327b1b` → T069 calculator実装 `d395797` | R11 P2-01は独立再Review待ち。T068 H2 5/0/0/0、MySQL smoke 1/0/0/0、T069指定回帰70/0/0/0。HR/法人別規程はATT-GATE-01〜06としてrelease gate | T070開始可。T069 code/台帳を独立Reviewへ提出し、V83のmerge/applyはV82後 |
