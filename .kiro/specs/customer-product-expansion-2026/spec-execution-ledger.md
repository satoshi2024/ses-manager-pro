...
| 10 | 2 | `dispatch-outsourcing-compliance-ledger` | T060〜T066 | `IN PROGRESS`（T060 PASS、R4-P1-01 VERIFIED_CLOSED、T061 START ALLOWED） | order PASS、G2確定済み。V83実在/V82欠番のformal decisionとV84 reservationをR10が確認。T061はV84で開始可、production release/apply authorizationなし | S10 dispatch-outsourcing-compliance-ledger 実装 | R10 reviewed Head `b75af1a1eff16e6c5723a2a2310a31ec324e7f80`（Base `df7f6b1f5e27b64876133d26debd95422d29379a`）→ current main `7f60738a0dd1b3a9314cc3b115dae1173673358d`（S11中央ledgerのみ後続） | T060 PASS、R4-P1-01 VERIFIED_CLOSED、CI全体1629/0/0/0、SpecDispatchConsistencyTest 9/0/0/0、FlywayEnvironmentEvidenceTest 1/0/0/0 | T061開始時にdb/migration latest再確認。V84 DDL開発可、production release/applyはM gate |
