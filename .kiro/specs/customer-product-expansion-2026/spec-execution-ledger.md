...
| 17 | 4 | `ai-feedback-learning` | T109〜T115 | **`IN PROGRESS`（T109 intermediate PASS、T110未着手）** | Round 1 独立Review（Head `835c8c86`）: T109 PASS / spec総合 NOT REVIEWABLE。P2×3（workLocation grain / EARLY_EXIT / L0 design token）。G10 mock/rule既定。F1（V108）は T110 | S17 ai-feedback-learning 実装 | Base `9d2c229b` → T109 Head `835c8c86` | Review再実行 L0 16/0/0/0。P2修正後 L0 17/0/0/0 | T110（V108 DDL）。次specは開始しない |
