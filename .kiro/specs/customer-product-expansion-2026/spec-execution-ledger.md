...
| 10 | 2 | `dispatch-outsourcing-compliance-ledger` | T060〜T066 | `IN PROGRESS / FAIL`（T060〜T065 PASS。T066実装/L4 1824/0/0/0提出済み、R22-P1-01〜05は修正実装済み・R10再Review待ち、G2実在証跡・Phase A/B・GATE-T066-HISTORY未達、T066 checkbox未完了） | order PASS、V84/V85実在。R19-P1-02/R19-P2-03/R20-P1-01 VERIFIED_CLOSED。R10がR21 canonical payload deltaを`ACCEPTED_FOR_IMPLEMENTATION`。R22対応でV1/V102/H2/entity/mapper、複合FK/self FK、DATETIME(6) assignment、partial/repair metadata gate、operation ledger append-only boundaryを同期。`GATE-T066-HISTORY`は`TRACKED P2 / production release gate / 未実装・未受入`でS10 PASS/S12開始を阻害しない | S10 dispatch T066 / R19-P1-01 R22 schema rework | Base `72b30e9eb8556e8c8f992fcd4505ebdc13e79d3e` → Head `5b4a08c45d0058ab1ee2a6a30ba62cd7aa131ccf` | focused 158/0/0/0、追加migration/spec 42/0/0/0、V102 MySQL smoke 1 skip（Docker不在、CIで実行）。T066 checkbox/S10/S12 status/ACTIVE/formal delivery変更なし | R10独立ReviewでR22-P1-01〜05とMySQL 0-skip smokeを確認後、G2 service/API/UI/security→L1〜L3→Phase A/B→実在証跡→T066 L4。S12はS10/S11双方PASSまでNOT READY |
