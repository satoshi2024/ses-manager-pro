...
| 11 | 2 | `attendance-leave-overtime-compliance` | T067〜T074 | `IN PROGRESS`（T067/T068/T069/T070完了、T071〜T074未着手） | order PASS、G6確定済み。dispatchと並行可。R2-P1-01はV82永久欠番、S11=V83、S10=V84の正式decisionでVERIFIED_CLOSED。R2-P1-02は発注者決定の方式A（休憩区間保存）を2026-08-09にV91追補+calculator区間intersection+境界回帰で実装済み（独立VERIFIED_CLOSED待ち）。V91実在に伴いS12〜S17の予約をV92〜V97へ繰り上げ済み | S11 attendance-leave-overtime-compliance 実装 | Base `5e29f39` → T067成果 `93c1ac6` → T068実装 `b327b1b` → T069 calculator実装 `d395797` → T070 workflow `cc7c15c` → V91方式A fix delta（current Head） | R11 migration decision follow-upでR2-P1-01 VERIFIED_CLOSED、R2-P1-02 OPEN、P0=0/P1=1/P2=2。Flyway/MySQL指定回帰10/0/0/0、T068 H2 5/0/0/0、T069指定回帰70/0/0/0、T070指定回帰17/0/0/0。V91 deltaはcalculator/休憩区間service/DDL指定回帰35/0/0/0。HR/法人別規程はATT-GATE-01〜06としてrelease gate | R2-P1-02が独立VERIFIED_CLOSEDになるまでT071・次Wave開始不可。V83を変更・再適用せず、V82を補填しない。V91はS11方式A追補専用でS12〜S17はV92〜V97 |
