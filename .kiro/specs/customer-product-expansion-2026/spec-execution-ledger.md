...
| 12 | 2 | `staffing-capacity-planning` | T075〜T080 | `NOT READY`（**S11 PASS済み・S10 PASS待ち**。S10/S11双方PASSまで着手不可。着手時はS12専用派工対話・V99採番を再確認） | dispatch/attendance PASS後S12 |  |  |  | R12 PASSでWave 2完了 |
