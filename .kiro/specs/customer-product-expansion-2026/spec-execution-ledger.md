...
| 11 | 2 | `attendance-leave-overtime-compliance` | T067〜T074 | `IN PROGRESS`（T067完了、T068〜T074未着手） | order PASS、G6確定済み。dispatchと並行可。次はT068（V83） | S11 attendance-leave-overtime-compliance 実装 | Base `5e29f39` → T067作業Head（本更新commit） | R11未開始。T067 L0 PASS、HR/法人別規程はATT-GATE-01〜06としてrelease gate | T068着手前にV83衝突を再確認し、T074後にR11へ提出 |
