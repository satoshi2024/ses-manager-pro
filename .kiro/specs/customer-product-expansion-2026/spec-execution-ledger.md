...
| 10 | 2 | `dispatch-outsourcing-compliance-ledger` | T060〜T066 | `IN PROGRESS`（T060 PASS、R4-P1-01 VERIFIED_CLOSED、T061 IMPLEMENTER COMPLETE / R10 REVIEW REQUESTED） | order PASS、G2確定済み。V83実在/V82欠番のformal decisionとS10正式migration V84をR10が確認。T061はV84 DDL/entity/H2/MySQL smoke/direct regressionまで完了、production release/apply authorizationなし | S10 dispatch-outsourcing-compliance-ledger T061 F1実装 | R10 reviewed Head `b75af1a1eff16e6c5723a2a2310a31ec324e7f80`（Base `df7f6b1f5e27b64876133d26debd95422d29379a`）→ T061 implementation Head `e7f7f19434e0e45d54888d6b468e9d8704c6056f` → ledger sync Head（本commit） | T060 PASS、R4-P1-01 VERIFIED_CLOSED、T061指定回帰: MySQL 1/0/0/0、H2 1/0/0/0、SpecDispatch 9/0/0/0、既存契約48/0/0/0、Compliance API 1/0/0/0、skip 0 | R10がT061 diff/DDL/entity/H2/MySQL/direct regressionを独立確認しPASSするまでT062/A1/B1/B2を開始しない。production release/applyはM gate |
