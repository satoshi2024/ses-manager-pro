...
| 15 | 3 | `accounting-payment-integration` | T094〜T101 / R4-T01〜R4-T08 | `IN PROGRESS (Stage A: SpecHead Revision)` | Base `f8b81e77` に対し Stage A SpecHead (V106.1 forward repair契約、時間/asOf決定表§6.1、3段階リースHTTP-outside-tx、原子補償、数値tax_code、全consumer SQL scope、4母集団照合、タスク分離) を改訂・承認申請中。Stage B 実装は未着手・未解放 | S15 R4 是正 / Stage A SpecHead | Base `f8b81e77` | Direct 50/50, MySQL 5/5, Fast 2381/2381 PASS (コード実装済み、Spec 整合・深化のため Stage A 改訂中) | Stage A SpecHead 承認 → Stage B 実装・検証 |
