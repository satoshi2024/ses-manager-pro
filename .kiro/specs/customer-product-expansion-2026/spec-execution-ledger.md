...
## S10 dispatch R21 canonical payload sync docs-only rework update

R19-P1-02はVERIFIED_CLOSED。R21 canonical payload sync再ReviewでP1-02/P1-03/P1-04/P2-01/P2-02はVERIFIED_CLOSED、P1-01はOPEN、R19-P1-01はOPEN / DECISION_DELTA_REWORK_REQUIREDを維持する。今回のdocs-only fixは、§9.1 authoritative canonical payloadへrecipient/display/company/config実render content hashを追加し、business key計算・delivery保存列・G2-DEL-17 canonicalizerを一致させる。R10のACCEPTED_FOR_IMPLEMENTATION前はV102/DDL/code/testを作成しない。T066 checkbox・ACTIVE化・本番交付・S12開始は禁止維持。
