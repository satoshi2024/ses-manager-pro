...
| 10 | 2 | `dispatch-outsourcing-compliance-ledger` | T060〜T066 | `IN PROGRESS / FAIL`（T060〜T065 PASS。T066実装/L4 1824/0/0/0提出済み、R21-P1-01/P1-02/P1-03/P1-04/P2-01/P2-02 VERIFIED_CLOSED、G2実在証跡・Phase A/B・GATE-T066-HISTORY未達、T066 checkbox未完了） | order PASS、V84/V85実在。R19-P1-02/R19-P2-03/R20-P1-01 VERIFIED_CLOSED。R10がR21 canonical payload deltaを`ACCEPTED_FOR_IMPLEMENTATION`。T066/R19-P1-01実装フェーズ1としてV102、V1、H2、G2 entity/mapper、delivery immutable source FK、V102専用MySQL smoke、V102予約整合guardを追加。GATE-T066-HISTORYは`TRACKED P2 / production release gate / 未実装・未受入`でS10 PASS/S12開始を阻害しない | S10 dispatch T066 / R19-P1-01 implementation phase 1 | Base `3f7cc518e928c02f8eba7c08f368beb5d8f33526` → 実装commitで固定。migrationはV84/V85実在、V102追加、V99永久欠番/V100 migration-dev/V101維持 | H2 schema 1/0/0/0、AllMappers 129/0/0/0、MigrationScriptIntegrity 27/0/0/0、SpecDispatchConsistencyTest 9/0/0/0、定向合計167/0/0/1。V102 MySQL smoke 1 skip（Docker不在、CIで実行）。T066 checkbox/S10/S12 status/ACTIVE/formal delivery変更なし | R10再Reviewでschema/CI MySQL smoke確認後、G2 service/API/UI/security→L1〜L3→Phase A/B→実在証跡→T066 L4。S12はS10/S11双方PASSまでNOT READY |
