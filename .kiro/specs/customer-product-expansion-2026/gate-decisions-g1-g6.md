...
- task 0は公式資料に基づくprovisional mappingと社内責任者承認で完了可能とする。社労士/弁護士/税理士による
  外部専門家Reviewは、法定帳票を本番交付する前および各specのM taskをPASSにする前のrelease gateとする。
