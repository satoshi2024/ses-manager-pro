...
| Scope expansion normalization | approval-decision、README、plan、requirements、design、tasks、inventory、review-ledger、中央traceability | DecisionId、OwnerRef、Base、reviewed Head、wave status、A2 N/A、production禁止境界を正本化。production変更なし | COMPLETE（docs-only gate、Plan delta Review pending） | f7d7d144（remoteへpush済み。最終handoff Headは外部通知で固定） |
