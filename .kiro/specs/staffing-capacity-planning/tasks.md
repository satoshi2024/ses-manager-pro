...
>
> **Migration**: 本specの予約番号は **V110**。dispatch（V84/V85＋G2 follow-up V102）とattendance（V83/V91/V98）の両方がPASS・merge済み後に着手する。
...
- [ ] F1. position/allocation/scenario DDL
  ...
  - **実装ガイダンス**: **V110**/V1/H2(`sql/schema-staffing-h2.sql`)/MySQL smoke、状態/区間/競合service。
