...
>
> **Migration**: 本specの予約番号は **V79**。external portal(V76)のsecurity chain merge後に着手する。
...
- [ ] F1. change/expense/1on1/survey DDL
  ...
  - **実装ガイダンス**: **V79**/V1/H2(`sql/schema-engineer-selfservice-h2.sql`)/MySQL smoke、本人scope、field allowlist。
