...
- [ ] R4-T03. 外部マスタ 10種別 固定 Contract Fixture 検証・数値 Tax Code & PII 完全遮断
...
- [ ] R4-T04. SQL Scope 境界制御 (経費 asOf 履歴照合・実在エンティティ組織導出 & 全 Consumer 対応) & 4言語 i18n
...
- [ ] R4-T06. BP / 経費 業務日付固定・AccountingTimezoneResolver (Tenant別設定) & 経費 CAS
