...
>
> **Migration**: 本specの予約番号は **V74**。order(V72)のmerge後、attendance(V74)と並行可。
...
- [ ] F1. workplace/profile/finding/delivery DDL
  ...
  - **実装ガイダンス**: **V74**/V1/H2(`sql/schema-dispatch-compliance-h2.sql`)/MySQL smoke、snapshot/permission。
