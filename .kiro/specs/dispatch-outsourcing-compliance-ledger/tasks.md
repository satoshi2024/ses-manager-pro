...
>
> **Migration**: 本specの予約番号は **V73**。order(V72)のmerge後、attendance(V74)と並行可。
...
- [ ] F1. workplace/profile/finding/delivery DDL
  ...
  - **実装ガイダンス**: **V73**/V1/H2(`sql/schema-dispatch-compliance-h2.sql`)/MySQL smoke、snapshot/permission。
