...
>
> **Migration**: 本specの予約番号は **V81**。order(V80)のmerge後、attendance(V82)と並行可。
...
- [ ] F1. workplace/profile/finding/delivery DDL
  ...
  - **実装ガイダンス**: **V81**/V1/H2(`sql/schema-dispatch-compliance-h2.sql`)/MySQL smoke、snapshot/permission。
