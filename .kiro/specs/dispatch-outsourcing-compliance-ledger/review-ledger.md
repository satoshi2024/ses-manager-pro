...
- **Provenance**: Base `df7f6b1f5e27b64876133d26debd95422d29379a` → current Head `08eb09802d07c6e272473495ac22f5057cd4bbba`（`main`=`origin/main`）。証跡test commit `55c39cdeb501b1206d78b61401900be33d4b6f09`、同期commit `08eb09802d07c6e272473495ac22f5057cd4bbba`、CI evidence run `31305828153`を固定する。
