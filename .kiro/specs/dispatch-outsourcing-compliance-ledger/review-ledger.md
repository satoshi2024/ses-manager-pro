...
- **Provenance**: Base `df7f6b1f5e27b64876133d26debd95422d29379a` → current Head `23e48e0689deabeab49f8888c3aac1bc8c11a97f`（`main`=`origin/main`）。証跡test commit `55c39cdeb501b1206d78b61401900be33d4b6f09`、同期commit `08eb09802d07c6e272473495ac22f5057cd4bbba`、provenance commit `23e48e0689deabeab49f8888c3aac1bc8c11a97f`、CI evidence run `31305828153`を固定する。
