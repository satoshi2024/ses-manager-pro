...
| previous current Head | 67a19e5e376490706a3b8d666468950cdd9c5c2c |
| code Head | 2799d69c4775a7143356883fe703b50fa55f3195 |
...
| order-acceptance-workflow-R7-P1-02 | P1 | code Headでの全量L4検証証拠未取得 | 単一クリーン `verify-like-ci.ps1` を全量実行し、全1545件成功（Tests run: 1545, Failures: 0, Errors: 0, Skipped: 0, BUILD SUCCESS, surefirebooter-20260807181237802）を確認（VERIFIED_CLOSED） |
...
| L4全量 | `verify-like-ci.ps1`: Tests run: 1545, Failures: 0, Errors: 0, Skipped: 0, BUILD SUCCESS (surefirebooter-20260807181237802) |
