...
- [x] F1. 基盤（マイグレーション・エンティティ・セキュリティ・i18n 凍結）
...
- [x] A1. 日次入力サービス（saveDaily・手動合計との排他） ※F 後
...
- [x] B1. 承認・差戻しとBP生成の共通化 ※F 後、A1 と並行可
