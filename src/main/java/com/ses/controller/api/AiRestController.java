            ...
            if (request.getEngineerId() != null) {
                ...
                if (eng != null) {
                    finalPrompt.append("【要員情報】\n")
                               ...
                               .append("- 希望単価: ").append(eng.getExpectedUnitPrice() != null ? eng.getExpectedUnitPrice() + "万円" : "未設定").append("\n")
            ...
            if (request.getProjectId() != null) {
                ...
                if (proj != null) {
                    finalPrompt.append("【案件情報】\n")
                               ...
                               .append("- 単価幅: ").append(proj.getUnitPriceMin() != null ? proj.getUnitPriceMin() : "未設定").append("〜").append(proj.getUnitPriceMax() != null ? proj.getUnitPriceMax() + "万円" : "未設定").append("\n")
