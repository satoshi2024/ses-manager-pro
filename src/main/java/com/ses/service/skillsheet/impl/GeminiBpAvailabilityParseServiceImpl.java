...
public class GeminiBpAvailabilityParseServiceImpl implements BpAvailabilityParseService {
    ...
    private static final String TRUSTED = """
            ...
            {"availability":{"initialName":"イニシャル","bpCompany":null,"skills":["Java"],"unitPrice":null,"availableFrom":null,"experienceYears":null,"remarks":null},"warnings":[]}
            """;
    ...
    public ParsedBpAvailabilityDto parse(String extractedText) {
        ...
        ParsedBpAvailabilityDto result = tryParse(call(extractedText, TRUSTED));
        if (result != null) {
            return result;
        }
    ...
    private String call(String source, String trusted) {
        return aiExecutionGateway.execute(AiGatewayRequest.builder()
                .useCase(AiGatewayRequest.USE_INGEST_BP)
