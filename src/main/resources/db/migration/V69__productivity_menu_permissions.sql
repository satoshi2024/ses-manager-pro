...
('search', '横断検索', '/search', '/api/search', 200, NOW(), NOW()),
('tasks', 'タスク管理', '/tasks', '/api/tasks', 210, NOW(), NOW()),
('saved-views', '保存ビュー', '/saved-views', '/api/saved-views', 220, NOW(), NOW()),
('batch-operations', '一括操作', '/batch-operations', '/api/batch-operations', 230, NOW(), NOW());
