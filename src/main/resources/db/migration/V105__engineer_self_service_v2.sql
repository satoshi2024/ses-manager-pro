...
CREATE TABLE IF NOT EXISTS t_engineer_change_request (
  ...
  reason              VARCHAR(1000) NULL COMMENT '申請理由・備考',
  attachment_document_id BIGINT    NULL COMMENT '証明書類等の文書ID',
...
CREATE TABLE IF NOT EXISTS t_survey_campaign (
  ...
  template_snapshot_json LONGTEXT NULL COMMENT '開始時のテンプレートスナップショットJSON',
