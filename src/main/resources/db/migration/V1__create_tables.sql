...
CREATE TABLE IF NOT EXISTS t_lifecycle_case (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    case_no VARCHAR(50) NOT NULL COMMENT '案件番号',
    ...
    anchor_date DATE NOT NULL COMMENT '基準日',
...
CREATE TABLE IF NOT EXISTS t_lifecycle_task (
    ...
    due_date DATE NOT NULL COMMENT '算出された期日',
    assignee_user_id BIGINT NULL COMMENT '解決された担当ユーザーID',
    assignee_role VARCHAR(30) NULL COMMENT '担当ロール',
    ...
    approval_request_id BIGINT NULL COMMENT '例外免除時の承認申請ID',
    version INT NOT NULL DEFAULT 0 COMMENT '楽観ロックバージョン',
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    created_by BIGINT NULL,
...
CREATE TABLE IF NOT EXISTS t_lifecycle_event (
    ...
    actor_user_id BIGINT NULL COMMENT '操作者ユーザーID。旧行では actor_type/confirmation_source 未設定のまま actor_user_id のみ保持され得る（V136 backfill 前）',
