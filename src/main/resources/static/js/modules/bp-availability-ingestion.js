...
<div class="d-flex flex-wrap justify-content-end align-items-center gap-1">${row.status === '要確認' ? `<a href="/bp-availability-ingestion/review/${row.id}" class="btn btn-sm btn-primary">レビュー</a>` : ''}
