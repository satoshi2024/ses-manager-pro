...
class ServiceRequestExportServiceTest {
    ...
    void setUp() {
        ...
        ServiceRequestCreateRequest req = ServiceRequestCreateRequest.builder()
                ...
                .build();
        serviceRequestService.createRequest(req, 1L, false, null);
    }
    ...
    void testExportCsv_withBomAndHeaders() {
        ...
        assertTrue(csvText.startsWith("\"リクエスト番号\",\"顧客名\",\"カテゴリ\"") || csvText.startsWith("リクエスト番号,顧客名,カテゴリ"),
                "ヘッダー行が含まれていること");
